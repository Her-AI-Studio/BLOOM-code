...
Your Brick **Kiosk-Modal** is ready!

Custom Bricks are modular components that add reusable functionality to your app.

## How to use it

Write your Python class inside `bricks/kiosk_modal/__init__.py` and add the `@brick` decorator.
```python
...
your brick is created under the `bricks/kiosk_modal` folder that contains the following files:
